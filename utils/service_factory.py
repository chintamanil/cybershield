...
class RedisFactory:
    ...
    def create_redis_connection():
        ...
        logger.info(f"Creating Redis connection to {redis_config.host}:{redis_config.port}")
...
class ServiceManager:
    ...
    def __init__(self):
        ...
        logger.info(f"ServiceManager initialized for {config.detector.environment} environment")
