...
class IOCPatterns:
    ...
    # File patterns
    EXECUTABLE_PATTERN = (
        r"\b\w+\.(?:exe|scr|bat|cmd|com|pif|vbs|js|jar|app|dmg|pkg|deb|rpm)\b"
    )
    ...
    def _compile_patterns(self) -> Dict[str, re.Pattern]:
        ...
        return {
            ...
            "suspicious_tld": re.compile(
                self.patterns.SUSPICIOUS_TLD_PATTERN, re.IGNORECASE
            ),
            ...
            "suspicious_email": re.compile(
                self.patterns.SUSPICIOUS_EMAIL_PATTERN, re.IGNORECASE
            ),
