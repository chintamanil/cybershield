...
def create_test_suite():
    ...
    suite.addTest(
        unittest.TestLoader().loadTestsFromTestCase(TestInteractiveMilvusViewer)
    )
    ...
    suite.addTest(
        unittest.TestLoader().loadTestsFromTestCase(TestMilvusConnectionParameters)
    )
    suite.addTest(unittest.TestLoader().loadTestsFromTestCase(TestMilvusErrorScenarios))
    suite.addTest(
        unittest.TestLoader().loadTestsFromTestCase(TestMilvusImportValidation)
    )
    ...
    suite.addTest(
        unittest.TestLoader().loadTestsFromTestCase(TestMilvusIngestionIntegration)
    )
    suite.addTest(
        unittest.TestLoader().loadTestsFromTestCase(TestMilvusDataPreprocessing)
    )
