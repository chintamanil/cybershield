    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        self.redis_cluster = elasticache.CfnCacheCluster(
            ...
            vpc_security_group_ids=[
                self._create_redis_security_group().security_group_id
            ],
        ...
        self.opensearch_domain = opensearch.Domain(
            ...
            capacity=opensearch.CapacityConfig(
                master_nodes=0, data_nodes=1, data_node_instance_type="t3.small.search"
            ),
    ...
    def _grant_ecs_permissions(self):
        ...
        self.ecs_service.task_definition.add_to_task_role_policy(
            iam.PolicyStatement(
                ...
                resources=[
                    f"arn:aws:ssm:{self.region}:{self.account}:parameter/cybershield/*"
                ],
            )
        )
    ...
    def _create_cloudfront(self):
        ...
        self.cloudfront = cloudfront.Distribution(
            ...
            log_bucket=s3.Bucket(
                self, "CloudFrontLogsBucket", encryption=s3.BucketEncryption.S3_MANAGED
            ),
        )
